import { CursosMockup, UsurioMockup, type Curso, type Usuario } from "./mockup";
...
export async function MeusCursos({
  ...
  const result: Curso[] = await fetch("http://localhost:3000/" + idUsuario, {
    method: "GET",
    headers: {
